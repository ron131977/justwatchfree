...
export const metadata: Metadata = {
  ...
  description: "Browse our complete collection of Movies & Tv Show from around the world.",
}
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-muted-foreground mb-8">
        Browse our complete collection of Movies & Tv Show from around the world.
      </p>
