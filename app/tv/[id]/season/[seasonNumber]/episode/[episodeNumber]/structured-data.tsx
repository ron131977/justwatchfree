...
export default function EpisodeStructuredData({ tvShow, season, episode, params }: EpisodeStructuredDataProps) {
  const structuredData = {
    ...
    url: `https://justwatchfree.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
    partOfSeries: {
      "@type": "TVSeries",
      name: tvShow.name,
    ...
    partOfSeason: {
      ...
      seasonNumber: Number.parseInt(params.seasonNumber),
      name: season.name,
      url: `https://justwatchfree.vercel.app/tv/${params.id}/season/${params.seasonNumber}`,
    },
    ...
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `https://justwatchfree.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
      },
    },
    video: {
      "@type": "VideoObject",
      ...
      contentUrl: `https://justwatchfree.vercel.app/tv/${params.id}/season/${params.seasonNumber}/episode/${params.episodeNumber}`,
    },
  }
