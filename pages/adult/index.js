...
export default function adult({ adultData }) {
    ...
    "@graph": [
      {
        ...
        name: "Justwatch Free™ – Adult Section.",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://justwatchfree.vercel.app/adult#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://justwatchfree.vercel.app/adult"],
          },
        ],
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Justwatch Free™ – Adult Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://justwatchfree.vercel.app/adult#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> Justwatch Free™ – Adult Section.</title>
        ...
        <meta
          property="og:title"
          content=" Justwatch Free™ – Adult Section. "
        />
        <meta
          property="og:url"
          content="https://justwatchfree.vercel.app/adult"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Justwatch Free™ Adult Section.</h1>
