...
const cookiepolicy = () => {
  ...
  return (
    <div>
      <Head>
        <title>Justwatch Free™ | Cookie Policy</title>
        <link
          rel='sitemap'
       ...
       <meta
        ...
        <meta property='og:title' content='Justwatch Free™ ' />
        <meta
        ...
        />
        <meta property='og:site_name' content='Justwatch Free™ ' />
        <meta
          property='og:image'
        ...
        <meta name='application-name' content='Justwatch Free™ ' />
        <meta
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <p style={{ color: '#666', marginBottom: '24px' }}>
                This is the Cookie Policy for Justwatch Free™, accessible from
                and its subdomains.
              </p>
