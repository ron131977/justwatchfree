...
export default function movies({ moviesData }) {
    ...
    "@graph": [
      {
        ...
        name: "Justwatch Free™ – Movies Section.",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://justwatchfree.vercel.app/movies#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://justwatchfree.vercel.app/movies"],
          },
        ],
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Justwatch Free™ – Movies Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://justwatchfree.vercel.app/movies#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> Justwatch Free™ – Movies Section.</title>
        ...
        <meta
          property="og:title"
          content=" Justwatch Free™ – Movies Section. "
        />
        <meta
          property="og:url"
          content="https://justwatchfree.vercel.app/movies"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Justwatch Free™ Movies Section.</h1>
