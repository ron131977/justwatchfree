...
// import { GetServerSideProps } from 'next';
// import { useRouter } from 'next/router';
// import { getDetails, getCast, getImageUrl, getRecommendations, getYouTubeTrailer } from '../../services/tmdb';
// import VideoPlayer from '../../components/VideoPlayer';
// import YouTubePlayer from '../../components/YouTubePlayer';
// import SEO from '../../components/SEO';
// import { ContentDetails, CastMember, MediaItem } from '../../types';
// import { Calendar, Clock, Star, User, Share2, X, Copy, Check, Lock, Play } from 'lucide-react';
// import Link from 'next/link';
...
// const WatchPage: React.FC<WatchPageProps> = ({ details, cast, initialRecommendations, type, id, youtubeTrailerId }) => {
//   const router = useRouter();
//   const [recommendations, setRecommendations] = useState<MediaItem[]>(initialRecommendations || []);
//   const [isShareOpen, setIsShareOpen] = useState(false);
//   const [copiedLink, setCopiedLink] = useState(false);
//   const [isPaidUser, setIsPaidUser] = useState(false); // In production, this would be from auth context
...
//                 type === 'tv' ? 'TV Shows' : 
//                 type === 'sports' ? 'Sports' : 'Live TV',
//         "item": `https://justwatchfree.vercel.app/${type === 'movie' ? 'movies' : 
//                 type === 'tv' ? 'tv' : 
//                 type === 'sports' ? 'sports' : 'live'}`
//       },
//       {
...
//     <div className="min-h-screen bg-miraj-black pt-20 md:pt-28 pb-20">
//       <SEO 
//         title={`${title} - Watch Free on Justwatch Free Official`} 
//         description={description}
//         image={getImageUrl(details.poster_path, 'original')}
//         type="video.movie"
//         schema={schema}
...
//                         <Lock size={20} className="text-miraj-gold" />
//                         Unlock Full Content
//                       </h3>
...
//                               <span className="text-2xl font-bold text-miraj-gold">$9.99/mo</span>
//                           </div>
...
//                           className="w-full bg-gradient-to-r from-miraj-gold to-yellow-500 text-black font-bold py-3 rounded-full hover:shadow-lg hover:shadow-miraj-gold/50 transition-all"
//                       >
//                           Subscribe Now
//                       </button>
//                       <p className="text-xs text-gray-500 text-center mt-4">Demo: Click to unlock for testing</p>
//                   </div>
//               </div>
//           </div>
//       )}
...
//       <div className="container mx-auto px-0 md:px-6 mb-8 mt-4 relative z-10">
//         <div className="w-full max-w-7xl mx-auto">
//             {/* Show YouTube Trailer if available and user hasn't paid, otherwise show full video player */}
...
//             {/* Pay Now Button - Only show if user hasn't paid and trailer is showing */}
//             {!isPaidUser && youtubeTrailerId && (
...
//                                 Unlock Full Movie
//                             </h3>
//                             <p className="text-gray-300 text-sm">Watch the complete movie in HD quality without interruptions</p>
//                         </div>
//                         <button 
//                             onClick={handlePayNow}
//                             className="flex items-center gap-2 bg-gradient-to-r from-miraj-gold to-yellow-500 hover:from-yellow-500 hover:to-miraj-gold text-black font-bold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-miraj-gold/50 whitespace-nowrap"
//                         >
//                             <Play size={20} fill="currentColor" />
//                             <span>Pay Now - $9.99</span>
//                         </button>
//                     </div>
//                 </div>
//             )}
...
//     if (type === 'movie' || type === 'tv') {
//         try {
//             youtubeTrailerId = await getYouTubeTrailer(type, id);
//         } catch (e) { 
//             console.warn("YouTube trailer fetch failed"); 
//         }
//     }
...
//   return (
//     <div className="min-h-screen bg-miraj-black pt-20 md:pt-28 pb-20">
//       {/* SEO - Different meta tags for trailer vs full video */}
//       {!isPaidUser && youtubeTrailerId ? (
//         // Trailer SEO
//         <>
//           <SEO 
//             title={`${title} - Official Trailer | Watch Free on Justwatch Free Official`} 
...
//             ]}
//           />
//           {/* YouTube Video Schema for Trailer */}
//           <script
//             type="application/ld+json"
...
//   getRecommendations,
//   getYouTubeTrailer,
//   // 🔥 Import your custom content arrays for server‑side detection
//   UNIQUE_MOVIES,
//   UNIQUE_TV_SHOWS,
//   UNIQUE_SPORTS,
//   UNIQUE_TV_LIVE,
...
//         <div className="text-center">
//           <h1 className="text-2xl font-bold text-white mb-4">Content Not Found</h1>
//           <Link href="/" className="text-miraj-gold hover:underline">
//             Return Home
//           </Link>
//         </div>
//       </div>
...
//   // ----- DYNAMIC UNLOCK MESSAGES BASED ON CONTENT TYPE -----
//   const getUnlockTitle = () => {
//     switch (type) {
//       case 'movie':
//         return 'Unlock Full Movie';
//       case 'tv':
//         return 'Unlock Full TV Show';
//       case 'sports':
//         return 'Unlock Full Sports Event';
//       case 'tv_live':
//         return 'Unlock Live TV';
//       default:
//         return 'Unlock Full Content';
//     }
//   };
...
//     switch (type) {
//       case 'movie':
//         return 'Watch the complete movie in HD quality without interruptions';
//       case 'tv':
//         return 'Watch all episodes in HD quality without interruptions';
//       case 'sports':
//         return 'Watch the full sports event in HD quality without interruptions';
//       case 'tv_live':
//         return 'Watch live TV in HD quality without interruptions';
//       default:
//         return 'Watch full content in HD quality without interruptions';
//     }
//   };
...
//           <SEO
//             title={`${title} - Official Trailer | Watch Free on Justwatch Free Official`}
//             description={`Watch the official trailer for ${title}. ${description.substring(
//               0,
//               150
//             )}... Unlock the full movie in HD quality.`}
//             image={getImageUrl(
...
//             <div className="flex items-center justify-between p-4 border-b border-white/10 bg-black/40">
//               <h3 className="text-lg font-bold text-white flex items-center gap-2">
//                 <Lock size={20} className="text-miraj-gold" /> Unlock Full Content
//               </h3>
...
//                 Demo: Click to unlock for testing
//               </p> */}
//             </div>
//           </div>
//         </div>
...
//           {/* ✅ DYNAMIC UNLOCK BUTTON – CORRECT LABEL FOR EACH CONTENT TYPE */}
//           {!isPaidUser && youtubeTrailerId && (
//             <div className="mt-6 bg-gradient-to-r from-miraj-red/20 to-miraj-gold/20 border-2 border-miraj-gold/50 rounded-xl p-6">
//               <div className="flex flex-col md:flex-row items-center justify-between gap-4">
//                 <div>
//                   <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
//                     <Lock size={20} className="text-miraj-gold" /> {getUnlockTitle()}
//                   </h3>
...
//                   className="flex items-center gap-2 bg-gradient-to-r from-miraj-gold to-yellow-500 hover:from-yellow-500 hover:to-miraj-gold text-black font-bold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-miraj-gold/50 whitespace-nowrap"
//                 >
//                   <Play size={20} fill="currentColor" /> <span>Pay Now - $9.99</span>
//                 </button> */}
//               </div>
//             </div>
//           )}
...
//                   className="bg-black/50 border border-white/10 rounded px-3 py-2 text-white w-20 text-center font-bold focus:border-miraj-gold focus:outline-none"
//                 />
//               </div>
//               <div className="flex flex-col">
//                 <label className="text-xs text-gray-400 font-bold mb-1">EPISODE</label>
...
//             <div className="flex items-center gap-4 text-sm text-gray-300 mb-6 flex-wrap">
//               <span className="flex items-center gap-1 text-miraj-gold font-bold bg-miraj-gold/10 px-2 py-1 rounded">
...
//               {details.runtime && (
//                 <span className="flex items-center gap-1">
//                   <Clock size={16} /> {details.runtime}m
//                 </span>
//               )}
//               <span className="border border-white/20 px-2 py-0.5 rounded text-xs uppercase font-bold">
//                 {type === 'tv_live' ? 'Live TV' : type.replace('_', ' ')}
...
//                     />
//                   </div>
//                   <h4 className="mt-2 text-sm font-bold text-white truncate group-hover:text-miraj-gold transition-colors">
...
//   // For sports/live TV, use full slug; otherwise extract numeric part if numeric
//   let id = rawId;
//   if ((type === 'movie' || type === 'tv') && /^\d+/.test(rawId)) {
//     id = rawId.split('-')[0];
//   }
...
//   try {
//     // ----- 1. DETECT CUSTOM CONTENT (all your UNIQUE_* arrays) -----
//     let customItem = null;
...
//     } else if (type === 'tv') {
//       customItem = UNIQUE_TV_SHOWS?.find(
//         (item) => String(item.id) === String(rawId) || String(item.id) === String(id)
//       );
//     } else if (type === 'sports') {
//       customItem = UNIQUE_SPORTS?.find(
//         (item) => String(item.id) === String(rawId) || String(item.id) === String(id)
//       );
//     } else if (type === 'tv_live') {
//       customItem = UNIQUE_TV_LIVE?.find(
//         (item) => String(item.id) === String(rawId) || String(item.id) === String(id)
//       );
//     }
...
//           cast = await getCast(type, id);
//         } catch (e) {
//           console.warn('Cast fetch failed');
//         }
//         try {
//           recommendations = await getRecommendations(type, id);
//         } catch (e) {
//           console.warn('Recs fetch failed');
//         }
//       }
...
//     // 🔥 STRIP STREAMS – NEVER PASS TO CLIENT
//     const { streams, ...safeDetails } = details as any;
      ...
      {!isPaidUser && youtubeTrailerId ? (
        <>
          <SEO
            ...
            type="video.other"
            path={router.asPath}
            keywords={[`${title} trailer`, `${title} official trailer`, `watch ${title} trailer`, `${title} movie trailer`, `${title} preview`, 'movie trailers', 'film trailers', 'justwatch free', 'free movie trailers', 'HD trailers']}
          />
          <script
            type="application/ld+json"
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                publisher: {
                  '@type': 'Organization',
                  name: 'Justwatch Free Official',
                  logo: { '@type': 'ImageObject', url: 'https://justwatchfree.vercel.app/logo.png' },
                },
              }),
            }}
          />
...
//   // Keep it exactly as you have it, I'm including it for completeness
//   const router = useRouter();
//   const [recommendations, setRecommendations] = useState<MediaItem[]>(initialRecommendations || []);
//   const [isShareOpen, setIsShareOpen] = useState(false);
//   const [copiedLink, setCopiedLink] = useState(false);
...
//   try {
//     let details: ContentDetails & { yt_id?: string } | null = null;
//     try {
//         details = await getDetails(type, id);
//     } catch (e) {
//         console.warn("Details fetch failed:", e);
...
//     // ✅ STEP 1: If details has a yt_id, use it immediately
//     let youtubeTrailerId: string | null = details.yt_id || null;

//     // ✅ STEP 2: Otherwise fetch from TMDB (for normal movies/TV)
//     if (!youtubeTrailerId && (type === 'movie' || type === 'tv')) {
//         try {
//             youtubeTrailerId = await getYouTubeTrailer(type, id);
//         } catch (e) { 
//             console.warn("YouTube trailer fetch failed"); 
