...
export default function tvshow({ tvshowData }) {
    ...
    "@graph": [
      {
        ...
        name: "Justwatch Free™ – Tv Show Section.",
      ...
      {
        "@type": "WebPage",
        "@id": "https://justwatchfree.vercel.app/tvshow#webpage",
        url: "https://justwatchfree.vercel.app/tvshow",
    ...
    "@graph": [
      {
        ...
        breadcrumb: {
          "@id": "https://justwatchfree.vercel.app/tvshow#breadcrumb",
        },
        inLanguage: "en-US",
        potentialAction: [
          {
            "@type": "ReadAction",
            target: ["https://justwatchfree.vercel.app/tvshow"],
          },
        ],
      },
      {
        ...
        width: 1280,
        height: 720,
        caption: "Justwatch Free™ – Tv Show Section",
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://justwatchfree.vercel.app/tvshow#breadcrumb",
  ...
  return (
    <>
      <Head>
        <title> Justwatch Free™ – Tv Show Section.</title>
        ...
        <meta
          property="og:title"
          content=" Justwatch Free™ – Tv Show Section. "
        />
        <meta
          property="og:url"
          content="https://justwatchfree.vercel.app/tvshow"
        />
        <meta
      ...
      <div style={styles.container}>
        ...
        <h1 style={styles.title}>Justwatch Free™ Tv Show Section.</h1>
