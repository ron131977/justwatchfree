...
const Contact: React.FC = () => {
  ...
  const schema = {
    ...
    "@type": "ContactPage",
    "name": "Contact Justwatch Free Official",
    "description": "Get in touch with the Justwatch Free Official team for support, requests, or DMCA inquiries.",
    "url": "https://justwatchfree.vercel.app/contact"
  };

  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="Contact Us - Justwatch Free Official" 
        description="Get in touch with the Justwatch Free Official team." 
        schema={schema}
        path="/contact"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 space-y-6">
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:support@Justwatch Free Official.com" className="text-miraj-red hover:underline font-medium">support@Justwatch Free Official.com</a>
                </div>
                ...
                <div className="bg-miraj-gray border border-white/5 p-6 rounded-xl">
                    ...
                    <a href="mailto:legal@Justwatch Free Official.com" className="text-miraj-red hover:underline font-medium">legal@Justwatch Free Official.com</a>
                </div>
            </div>
