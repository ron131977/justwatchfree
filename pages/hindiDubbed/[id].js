  ...
  JSON.stringify({
    ...
    "@graph": [
      ...
      },
      {
        ...
        breadcrumb: {
          "@id": "https://justwatchfree.vercel.app/#breadcrumb"
        },
        inLanguage: "en-US",
        potentialAction: [
          {
...
export default function hindiDubbedArticle({ hindiDubbedItem, videoSources = [] }) {
  ...
  return (
    <>
         <Head>
      <title>Justwatch Free™ – {hindiDubbedItem.title || "Default Title"}</title>
        ...
        />
         <meta   name="keywords" content={hindiDubbedItem.keywords} />
        <meta
          property="og:description"
          content="Justwatch Free™: Your trusted source for breaking news, global updates, and real-time coverage of politics, hindiDubbed, technology, culture, sports, and more—24/7."
        />
        <meta
          name="description"
          content="Justwatch Free™: Your trusted source for breaking news, global updates, and real-time coverage of politics, hindiDubbed, technology, culture, sports, and more—24/7."
        ...
        <meta
          property="og:title"
          content=" Justwatch Free™ - Online. Stream. Download. "
        />
