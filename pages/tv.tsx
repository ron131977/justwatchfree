...
//     try {
//       const results = await searchContent(searchQuery);
//       // Filter out items without poster – no placeholders
...
//   // Fetch TV shows (only once, no movie interference)
//   useEffect(() => {
//     const fetchShows = async () => {
//       try {
//         const data = await getTVShows('popular', 1);
//         // Only keep items with a poster – no static fallback
...
const TVShows: React.FC = () => {
  ...
  const schema = {
    ...
    "description": "Watch the newest TV series from this year on Justwatch Free Official.",
    "url": "https://justwatchfree.vercel.app/tv"
  };
