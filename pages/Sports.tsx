...
import { getSports } from '../services/tmdb';
...
const Sports: React.FC = () => {
  ...
  const schema = {
    ...
    "mainEntity": {
      ...
      "itemListElement": sports.slice(0, 10).map((item, index) => ({
        "@type": "ListItem",
        "position": index + 1,
        "url": `https://justwatchfree.vercel.app/Sports/${item.id}`,
  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="Live Sports - Watch Cricket, Football & More | Justwatch Free Official" 
        description="Stream live sports events for free. Watch Cricket, Football, UFC, F1 and more in high definition on Justwatch Free Official." 
        schema={schema}
        path="/sports"
      />
