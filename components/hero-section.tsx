...
//   return (
//     <section className={`relative overflow-hidden rounded-2xl ${isMobile ? "h-[750px]" : "h-[600px]"}`}>
//       {/* Background image with gradient overlay */}
//       <div className="absolute inset-0 w-full h-full">
//         <Image
//           src={currentDoc.thumbnailUrl || "/placeholder.svg"}
...
//           style={{
//             objectFit: isMobile ? "contain" : "cover", // Ensures image fits well on all screens
