...
//   return (
//     <div>
//         <h2 className="text-2xl font-semibold mb-4 text-center">Tv Series Content Section</h2>
...
//                       value={episode.server2 || ""}
//                       onChange={(e) => handleEpisodeChange(seriesIndex, episodeIndex, "server2", e.target.value)}
//                     />
//                     <Input
//                       className="mb-2"
//                       placeholder="Server 3"
//                       value={episode.server3 || ""}
//                       onChange={(e) => handleEpisodeChange(seriesIndex, episodeIndex, "server3", e.target.value)}
//                     />
//                     <Input
//                       className="mb-2"
//                       placeholder="Server 4"
//                       value={episode.server4 || ""}
//                       onChange={(e) => handleEpisodeChange(seriesIndex, episodeIndex, "server4", e.target.value)}
//                     />
//                     <Input
//                       className="mb-2"
...
//                     />
//                     <Button variant="destructive" onClick={() => handleDeleteEpisode(seriesIndex, episodeIndex)}>
//                       Delete Episode
//                     </Button>
//                   </div>
//                 ))}
...
export function SeriesForm({ data, onSave }: SeriesFormProps) {
  ...
  return (
    <div>
      {seriesList.map((series, seriesIndex, episodeIndex) => (
        <Accordion type="single" collapsible key={seriesIndex} className="mb-4">
          <AccordionItem value={`series-${seriesIndex}`}>
            <AccordionTrigger>{series.title || `Series ${seriesIndex + 1}`}</AccordionTrigger>
            <AccordionContent>
              <div className="mb-4 p-4 border rounded">
                ...
                />
                  <Button  onClick={handleAddSeries}>Add Series</Button>
                <Button className="ml-2" variant="destructive" onClick={() => handleDeleteSeries(seriesIndex)}>
                  Delete Series
                </Button>
