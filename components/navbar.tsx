...
import { Search, Menu, X, Film, History, Award, Bookmark, Languages, Tv, Ghost, Brain,  Laugh, Eye, Cpu, Users, ShieldAlert, Trophy, Globe } from "lucide-react"
...
export function Navbar() {
  ...
  const categories = [
    { name: "Movies", href: "/category/movie", icon: <Film className="h-4 w-4 mr-2" /> },
    { name: "Tv Show", href: "/category/tvshow", icon: <Tv className="h-4 w-4 mr-2" /> },
    { name: "Adult", href: "/category/adult", icon: <ShieldAlert className="h-4 w-4 mr-2" /> },
    { name: "Hindi Dubbed", href: "/category/Hindi-Dubbed", icon: <Languages className="h-4 w-4 mr-2" /> },
    // { name: "Society", href: "/category/society", icon: <Globe className="h-4 w-4 mr-2" /> },
    // { name: "Action", href: "/category/action", icon: <Film className="h-4 w-4 mr-2" /> },
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-50 bg-background md:hidden">
          <div className="flex h-16 items-center justify-between px-4">
            <Link href="/" className="flex items-center space-x-2">
              <Film className="h-6 w-6 text-primary" />
              <span className="font-bold text-xl">JustWatch Fre</span>
            </Link>
