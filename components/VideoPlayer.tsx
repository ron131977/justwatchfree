...
//   // ---------- STREAMS: RESOLVED FROM ALL CUSTOM ARRAYS + TMDB FALLBACK ----------
...
//           ...s,
//           type:
//             s.url.includes('.m3u8') || s.url.includes('hls')
//               ? 'hls'
//               : s.type || 'iframe',
//         }));
//       }
...
//     // ----- 1. CUSTOM CONTENT – SEARCH ALL RELEVANT ARRAYS -----
//     if (type === 'movie') {
//       // Search ALL movie arrays
//       const customMovie =
...
//     // ----- 2. TMDB FALLBACK – ONLY FOR NUMERIC IDs (REAL TMDB) -----
//     // If we reach here, no custom stream was found.
//     // We still use the original tmdbId – if it's a string like "tu-meri...",
//     // the generated URLs will be invalid, but that's fine because we already
//     // tried custom content and found nothing – so this content genuinely has no streams.
//     if (type === 'movie') {
//       return [
...
//     if (!current) {
//       if (streams.length === 0) return; // still no streams
//       setPlayerError(true);
//       setIsLoading(false);
//       return;
//     }
...
//   // ---------- FULLSCREEN (PRODUCTION READY, UNCHANGED) ----------
...
//                 <option key={p} value={p} className="bg-miraj-black">
//                   {p}
//                 </option>
//               ))}
//             </select>
